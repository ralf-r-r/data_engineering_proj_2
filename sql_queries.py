...
CREATE TABLE IF NOT EXISTS
songplays (
    songplay_id INTEGER IDENTITY(1,1), start_time TIMESTAMP NOT NULL ,user_id INTEGER NOT NULL,
    level VARCHAR, song_id VARCHAR NOT NULL, artist_id VARCHAR NOT NULL, 
    session_id INTEGER NOT NULL, location VARCHAR, user_agent VARCHAR
)
""")
...
CREATE TABLE IF NOT EXISTS
users(
    user_id INTEGER NOT NULL, first_name VARCHAR NOT NULL, last_name VARCHAR NOT NULL, 
...
CREATE TABLE IF NOT EXISTS
artists(
    artist_id VARCHAR NOT NULL, name VARCHAR NOT NULL, location VARCHAR, lattitude DOUBLE PRECISION, 
...
CREATE TABLE IF NOT EXISTS
time(
    start_time TIMESTAMP NOT NULL, hour INTEGER NOT NULL, day INTEGER NOT NULL, week INTEGER NOT NULL, 
